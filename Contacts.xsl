                ...
                <section>
                    <div class="container">
                        <div class="contactinfo">
                            <xsl:for-each select="Containers/ContactInfo">
                                <div>
                                    <h2>Contact Info</h2>
                                    <ul class="info">
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span><xsl:value-of select="Telephone"/></span>
                                        </li>
                                    </ul>
                                </div>
                            </xsl:for-each>
                        ...
                        <xsl:for-each select="Containers/ContactForm">
                            <div class="contactForm">
                                <h1>Send a Message</h1>
                                <div class="formBox">
                                    <div class="inputBox w50">
                                        <input type="text" name="" required="" />
                                        <span><xsl:value-of select="Fname"/></span>
                                    </div>
                                    <div class="inputBox w50">
                                        <input type="text" name="" required="" />
                                        <span><xsl:value-of select="Lname"/></span>
                                    </div>
                                    <div class="inputBox w50">
                                        <input type="text" name="" required="" />
                                        <span><xsl:value-of select="Emailid"/></span>
                                    </div>
                                    <div class="inputBox w50">
                                        <input type="text" name="" required="" />
                                        <span><xsl:value-of select="Mnumber"/></span>
                                    </div>
                                    <div class="inputBox w50">
                                        <textarea type="text" name="" required="" />
                                        <span><xsl:value-of select="Messages"/></span>
                                    </div>
