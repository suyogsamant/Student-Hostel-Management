...
<head>
    ...
    <title>Visitor Record View</title>
...
<body>
    ...
    <div class="container">
        <h3 style="text-align:center">Visitor Hostel Records</h3>
        <br>
        <input type="text" name="search" id="search" placeholder="Search your record" class="form-control">
        <br>
        <table id="visitor_data" class="table table-bordered table-responsive" width="100%">
